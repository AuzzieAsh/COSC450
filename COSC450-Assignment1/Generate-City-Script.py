...
# Field Material
fieldMaterial = bpy.data.materials.new("fieldMaterial")
fieldMaterial.diffuse_color = (0, 1 ,0)
fieldMaterial.diffuse_shader = 'LAMBERT'
fieldMaterial.diffuse_intensity = 0.1
fieldMaterial.emit = 0.5
